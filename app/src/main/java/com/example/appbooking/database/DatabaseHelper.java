...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "db_booking_app";
    ...
    public static final String COL_WISATA = "asal";
    public static final String COL_HOTEL = "tujuan";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_BOOK + " (" + COL_ID_BOOK + " INTEGER PRIMARY KEY AUTOINCREMENT, " +
                COL_WISATA + " TEXT, " + COL_HOTEL + " TEXT" + ", " + COL_TANGGAL + " TEXT, " + COL_DEWASA + " TEXT, "
                + COL_ANAK + " TEXT)");
